...
<a class="social-btn" href="https://www.facebook.com/madhushalasoftware1330/followers/" target="_blank">&#128241; Facebook</a>
    ...
    {
        "keywords": ["restro", "restaurant delete", "delete query restro", "restro delete", "quaey restro"],
        ...
        "reply": "Here is the <strong>Madhushala Database Delete Query - Restro</strong> file. Click the button to view it."
    },
    # ── SQL Server Installation ─────────────────────────────────────
    {
        "keywords": ["manual sql", "manual installation sql", "manual install sql", "sql manual", "sql 2014 manual"],
        "label": None, "link": None,
...
<a class="drive-btn" href="https://drive.google.com/file/d/1SO2jdt3mlnGY3UTh8oPJoyKoXaBOWbLd/view?usp=sharing" target="_blank" style="margin-top:8px;">&#128190; Download SQL Management Studio</a><br>
<a class="drive-btn" href="https://drive.google.com/file/d/1gl-wYt_eQ9CWhVd2RfW8bBwF4f9pU5nF/view?usp=sharing" target="_blank" style="margin-top:8px;">&#128190; Download SAP Crystal Reports 13.0 Runtime (32-bit)</a>"""
    },
    {
        "keywords": ["automatic sql", "auto sql", "automatic installation sql", "sql automatic", "sql 2014 automatic", "sql 2014 auto"],
        ...
        "reply": "Here is the <strong>Automatic Microsoft SQL Server 2014 Installer</strong>. Click below to download from Google Drive."
    },
    # ── MS Office ──────────────────────────────────────────────────
    {
        "keywords": ["ms office", "office 2010", "ms office 2010", "office 32 bit", "ms office 32"],
...
<a class="drive-btn" href="https://drive.google.com/file/d/11KDwuAsYIOpbSYXD5V4tonYr1A0yPFEH/view?usp=sharing" target="_blank" style="margin-top:8px;">&#128190; AccessDatabaseEngine 64-bit</a>"""
    },
    # ── EPOS QR Code Error ─────────────────────────────────────────
    {
        ...
        "reply": "Here is the <strong>EPOS QR Code DLL Fix</strong> file. Click below to download and resolve the QR Code error."
    },
]

def match_query(user_input):
    lower = user_input.lower().strip()
    greet_words = ["hi", "hello", "hey", "helo", "hii", "hai", "start", "namaste", "good morning", "good evening", "good afternoon", "help me"]
...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  /* ── Topbar ── */
  .topbar { display:flex; align-items:center; justify-content:space-between; padding:14px 28px; background:#ffffff; border-bottom:1px solid #ede8e2; box-shadow:0 1px 4px #00000010; flex-shrink:0; }
  .topbar-left { display:flex; align-items:center; gap:12px; }
  .logo-icon { width:38px; height:38px; border-radius:10px; background:linear-gradient(135deg,#b84a00,#7c2000); display:flex; align-items:center; justify-content:center; font-size:18px; color:#ffd580; box-shadow:0 2px 8px #b84a0040; }
  .logo-text { font-size:16px; font-weight:700; color:#2d1200; letter-spacing:-0.3px; }
  ...
  /* ── Welcome ── */
  .welcome-center { display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; flex:1; padding:40px 20px 10px; gap:12px; }
  ...
  .welcome-title { font-size:28px; font-weight:700; color:#2d1200; font-family:'Playfair Display',serif; letter-spacing:-0.5px; }
  .welcome-sub { font-size:15px; color:#a07060; max-width:440px; line-height:1.6; }
  .quick-chips { display:flex; flex-wrap:wrap; justify-content:center; gap:8px; margin-top:8px; max-width:620px; }
  ...
  .bubble.bot  { background:#ffffff; color:#2d1200; border:1px solid #ede0d4; border-bottom-left-radius:4px; }
  ...
  .social-btn:hover { background:#b84a00; color:#fff; border-color:#b84a00; }

  /* ── Typing ── */
  .typing { display:flex; align-items:flex-end; gap:10px; }
  .dots-wrap { background:#fff; border:1px solid #ede0d4; border-radius:18px 18px 18px 4px; padding:14px 18px; display:flex; gap:5px; box-shadow:0 1px 6px #00000012; }
  ...
  .input-row { display:flex; align-items:center; padding:4px 8px 4px 18px; }
  ...
  #sendBtn { width:38px; height:38px; border-radius:10px; border:none; background:linear-gradient(135deg,#b84a00,#7c2000); color:#fff; font-size:16px; cursor:pointer; display:flex; align-items:center; justify-content:center; flex-shrink:0; transition:opacity .2s; }
  ...
  .contact-number { font-size:17px; font-weight:700; color:#b84a00; text-decoration:none; letter-spacing:0.3px; }
  ...
  <div id="chatbox">
    <div class="welcome-center" id="welcomeBlock">
      ...
      <div class="quick-chips">
        ...
        <button class="qchip" onclick="sendChip('Give me the madhushala delhi pos setup file')">&#128190; Delhi POS Setup</button>
        ...
        <button class="qchip" onclick="sendChip('Manual SQL installation')">&#128421; SQL Manual Install</button>
        <button class="qchip" onclick="sendChip('Automatic SQL installation')">&#128421; SQL Auto Install</button>
  ...
  <div class="bottom-area">
    <div class="input-card">
      ...
      <div class="input-chips">
        ...
        <button class="ichip" onclick="sendChip('Give me the madhushala delhi pos setup file')">Delhi POS</button>
        ...
        <button class="ichip" onclick="sendChip('Madhushala POS database delete query')">POS Delete</button>
        ...
        <button class="ichip" onclick="sendChip('AccessDatabaseEngine')">Access DB Engine</button>
  ...
  <div class="modal-box">
    ...
    <div class="contact-card">
      ...
      <div>
        ...
        <a class="contact-number" href="tel:+918101434343">+91 81014 34343</a>
      </div>
    </div>
    <div class="contact-card">
      <div class="contact-icon">&#128200;</div>
      <div>
        ...
        <a class="contact-number" href="tel:+919836362143">+91 98363 62143</a>
      </div>
    </div>
    <div class="contact-card" style="margin-bottom:0;">
      <div class="contact-icon">&#128172;</div>
      <div>
        <div class="contact-label">Enquiry</div>
        <a class="contact-number" href="tel:+919836362143">+91 98363 62143</a>
      </div>
    </div>
...
<script>
  ...
  async function sendMessage(){
    ...
    try{
      ...
      let html = data.reply;
      if(data.link){
        html += '<br><a class="drive-btn" href="'+data.link+'" target="_blank">&#128193; Open: '+data.label+'</a>';
      }
      appendMsg('bot', html);
    } catch(e){
      hideTyping();
...
def chat():
    ...
    if match:
        ...
        return jsonify({
            "reply":"I'm sorry, I didn't understand that. Please use the quick chips below or type keywords like:<br>&#8226; Setup File &nbsp;&#8226; CRM Login &nbsp;&#8226; Delete Query<br>&#8226; SQL Install &nbsp;&#8226; MS Office &nbsp;&#8226; Downloader",
