...
try:
    from updater import check_for_update, download_new_exe, restart_app, start_background_checker, get_local_version
    UPDATER_AVAILABLE = True
except ImportError:
    UPDATER_AVAILABLE = False
    def get_local_version(): return "1.0.0"

app = Flask(__name__)
app.secret_key = "madhushala@secret#2026"

# ── Login Credentials ─────────────────────────────────────
USERS = {
    "admin":   "madhushala@123",
    "support": "support@123",
    "staff":   "staff@123",
}
...
<a class="social-btn" href="https://www.facebook.com/madhushalasoftware1330/followers/" target="_blank">&#128241; Facebook</a>
    ...
    },
    {
        ...
        "link": "https://www.dropbox.com/scl/fi/n56cb4lt2lw7nwsklanlz/Madhushala-Setup-Files-2.zip?rlkey=oz3mzm1qbixuo08jia0yuizc9&st=tqvkmhqw&dl=1",
    ...
    },
    {
        ...
        "link": "https://www.dropbox.com/scl/fi/8af05z6w625q8qghnkntg/Restro-Setup-files-3.zip?rlkey=c1luies0uxzspt39rmi52f8w6&st=c3rdkmn6&dl=1",
        "reply": "Here is your <strong>Restaurant Setup File</strong>. Click below to download from Google Drive."
    },
    {
        "keywords": ["data cleaner","madhushala data cleaner","ultimate data cleaner","restro data cleaner","cleaner"],
        "label": None, "link": None,
        "reply": """Here are the <strong>Madhushala Data Cleaner</strong> files:<br><br>
<a class="drive-btn" href="https://drive.google.com/file/d/11rBi1CysFiGemAm19BbYB-pIVb4IwRb7/view?usp=sharing" target="_blank">&#128190; Ultimate DateWise Data Cleaner</a><br>
<a class="drive-btn" href="https://drive.google.com/file/d/1fnH-j0kUFGwFtrvwCcoY5FqN_l4dyCQq/view?usp=sharing" target="_blank" style="margin-top:8px;display:inline-block;">&#128190; Restro Data Cleaner</a>"""
    },
    {
        "keywords": ["pos setup","madhushala pos setup","pos setup file"],
        "label": "Madhushala POS Setup File",
        "link": "https://www.dropbox.com/scl/fi/ezheim1itx02384850mw7/PUNE_ePOS-2.zip?rlkey=mzxtvf3erx313a8qel8p7y7bs&st=gewzgmwt&dl=1",
    ...
    },
    {
        ...
        "link": "https://www.dropbox.com/scl/fi/vbkhrrzv8ty9g4bj5zoiq/Debug.zip?rlkey=0an19diupej0cnnssule3xjow&st=vfg37gzg&dl=1",
    ...
    },
    {
        ...
        "link": "https://www.dropbox.com/scl/fi/1h2jeedq08r0rvt0ihury/Madhushala-Ultimate-Downloader.exe?rlkey=8hby6ncb8gcmlqaqtuez7oc1m&st=t6ek0nzt&dl=1",
    ...
    {
        "keywords": ["amc","madhushala amc","madhushala software amc","madhusala amc","software amc"],
        "label": "Madhushala Software AMC",
        "link": "https://www.dropbox.com/scl/fi/1ysr5vsh6g3ek1ohshd1a/AMC.pdf?rlkey=e9ydoratgrgblh8kyuehuhde4&st=u42gyobg&dl=1",
        "reply": "Here is the <strong>Madhushala Software AMC</strong> file. Click below to access it from Google Drive."
    },
    {
...
<a class="drive-btn" href="https://www.dropbox.com/scl/fi/cxy1ncs83xo2zht3mfrb2/SQLEXPR_x64_ENU.exe?rlkey=5f74fvah95ijbj32vv88mvsbp&st=ngxvpkjv&dl=1" target="_blank">&#128190; Download SQLEXPR</a><br>
<a class="drive-btn" href="https://www.dropbox.com/scl/fi/by90urc3wizfoz50u70fv/SQLManagementStudio_x64_ENU.zip?rlkey=yk7okrb3i4wlrst39eldqqjue&st=9jnwke2w&dl=1" target="_blank" style="margin-top:8px;display:inline-block;">&#128190; Download SQL Management Studio</a><br>
<a class="drive-btn" href="https://www.dropbox.com/scl/fi/mncrbxxxba5if96nqyabq/CRRuntime_32bit_13_0_12.msi?rlkey=irkho1htmjwhnubf441yp2f0t&st=hv2pf7ab&dl=1" target="_blank" style="margin-top:8px;display:inline-block;">&#128190; SAP Crystal Reports 13.0 Runtime (32-bit)</a>"""
    },
    {
        "keywords": ["automatic sql","auto sql","sql automatic","sql 2014 automatic"],
        "label": "SQL Server 2014 Automatic Installer",
        "link": "https://www.dropbox.com/scl/fi/lj4g3rvktrrd3pyteu9tb/Madhushala_Installer.exe?rlkey=0at456544x634jv6w7b1ba8m5&st=w93lbu6s&dl=1",
...
<a class="drive-btn" href="https://drive.google.com/file/d/11KDwuAsYIOpbSYXD5V4tonYr1A0yPFEH/view?usp=sharing" target="_blank" style="margin-top:8px;display:inline-block;">&#128190; AccessDatabaseEngine 64-bit</a>"""
    ...
    {
        "keywords": ["quickheal","quick heal","quickheal download","quick heal download","antivirus","quickheal antivirus"],
        "label": "Quickheal Download",
        "link": "https://drive.google.com/file/d/1RjqqX9f22dcp_QaY57fiCWQKEjCTXxoe/view?usp=sharing",
        "reply": "Here is the <strong>Quickheal Download</strong> link. Click below to access it from Google Drive."
    },
    {
        "keywords": ["demo database","madhushala demo","ultimate demo database","demo db","madhushala ultimate demo"],
        "label": "Madhushala Ultimate Demo Database",
        "link": "https://www.dropbox.com/scl/fi/pq2lqoxiwz7jppt4z7rw7/Saturday-3.zip?rlkey=totuhr6w9h8e3myvv0o0ygl9t&st=9xs2dvqn&dl=1",
        "reply": "Here is the <strong>Madhushala Ultimate Demo Database</strong>. Click below to download."
    },
    {
        "keywords": ["restaurant new exe","restro new exe","restaurant exe","new restro exe","restro exe"],
        "label": "Restaurant New EXE",
        "link": "https://www.dropbox.com/scl/fi/ded6x3g45yd7mklzs1eln/Restro_23-02-2026.zip?rlkey=apqknk7zmovkjnfn9fg68amx5&st=adcmaw7m&dl=1",
...
def match_query(user_input):
    ...
    # Data Cleaner - check before restaurant
    for kw in ["data cleaner","madhushala data cleaner","ultimate data cleaner","restro data cleaner","cleaner"]:
        if kw in lower:
            return KNOWLEDGE_BASE[6]

    # AMC check
    for kw in ["amc","madhushala amc","madhushala software amc","madhusala amc","software amc"]:
        if kw in lower:
...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  /* ── Update Banner ── */
  #updateBanner { display:none; position:fixed; top:0; left:0; right:0; z-index:9999;
    background:linear-gradient(90deg,#1a7a00,#2ea600); color:#fff;
    padding:10px 24px; font-size:13.5px; font-weight:500;
    align-items:center; justify-content:center; gap:16px;
    box-shadow:0 2px 12px #00000030; animation:slideDown .4s ease; }
  @keyframes slideDown { from{transform:translateY(-100%)} to{transform:translateY(0)} }
  #updateBanner.show { display:flex; }
  .update-btn { background:#fff; color:#1a7a00; border:none; border-radius:8px;
    padding:6px 18px; font-size:13px; font-weight:700; cursor:pointer; font-family:Inter,sans-serif; }
  .update-btn:hover { background:#e8ffe8; }
  .update-dismiss { background:none; border:1.5px solid #ffffff80; color:#fff; border-radius:8px;
    padding:6px 14px; font-size:12px; cursor:pointer; font-family:Inter,sans-serif; }

  /* Version badge in topbar */
  .version-badge { font-size:10px; background:#fff4ee; color:#b84a00; border:1px solid #e8d0b8;
...
<div id="updateBanner">
  ...
  <span id="updateVersionText" style="opacity:0.85;font-size:12px;"></span>
  <button class="update-btn" onclick="doUpdate()">&#11015; Update Now</button>
  <button class="update-dismiss" onclick="document.getElementById('updateBanner').classList.remove('show')">Later</button>
</div>
...
<div class="topbar">
  <div class="topbar-left">
    ...
    <div>
      ...
      <div class="logo-sub">Software Assistant <span class="version-badge" id="versionBadge">v1.0.0</span></div>
    </div>
  </div>
  <div class="topbar-right">
    ...
    <a href="/logout" style="padding:7px 16px;border-radius:8px;font-size:13px;font-weight:500;border:1px solid #e0d0c0;background:#fff;color:#7c3000;cursor:pointer;text-decoration:none;font-family:Inter,sans-serif;display:flex;align-items:center;gap:5px;">&#128275; Logout</a>
  </div>
</div>
  ...
  <div id="chatbox">
    <div class="welcome-center" id="welcomeBlock">
      ...
      <div class="quick-chips">
        ...
        <button class="qchip" onclick="sendChip('Madhushala data cleaner')">&#129529; Data Cleaner</button>
        <button class="qchip" onclick="sendChip('Madhushala software AMC')">&#128196; AMC</button>
        ...
        <button class="qchip" onclick="sendChip('Quickheal download')">&#128737; Quickheal</button>
        <button class="qchip" onclick="sendChip('Madhushala ultimate demo database')">&#128190; Demo Database</button>
        <button class="qchip" onclick="sendChip('Restaurant new exe')">&#128190; Restaurant EXE</button>
  ...
  <div class="bottom-area">
    <div class="input-card">
      ...
      <div class="input-chips">
        ...
        <button class="ichip" onclick="sendChip('Madhushala data cleaner')">Data Cleaner</button>
        <button class="ichip" onclick="sendChip('Madhushala software AMC')">AMC</button>
        ...
        <button class="ichip" onclick="sendChip('Quickheal download')">Quickheal</button>
        <button class="ichip" onclick="sendChip('Madhushala ultimate demo database')">Demo Database</button>
        <button class="ichip" onclick="sendChip('Restaurant new exe')">Restaurant EXE</button>
...
<script>
  ...
  async function checkForUpdate(){
    try {
      ...
      if(d.update_available){
        ...
        const verText = document.getElementById('updateVersionText');
        if(verText) verText.textContent = 'v' + d.local + ' → v' + d.remote;
  ...
  async function doUpdate(){
    const banner = document.getElementById('updateBanner');
    if(banner) banner.innerHTML = '<span>&#9203; Downloading update... Please wait, app will restart automatically.</span>';
    try {
      await fetch('/do-update', {method:'POST'});
    } catch(e){}
  }
  ...
  window.addEventListener('load', function(){
    checkVersion();
    setTimeout(checkForUpdate, 5000); // check after 5s
    setInterval(checkForUpdate, 60 * 60 * 1000); // recheck every hour
  });
</script>
</body>
</html>
...
<meta charset="UTF-8"/>
<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
<title>madhushalasoftwareGpt — Login</title>
<style>
  @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Playfair+Display:wght@700&display=swap');
  * { margin:0; padding:0; box-sizing:border-box; }
  body {
    ...
    min-height:100vh;
    background:linear-gradient(135deg,#2d1200 0%,#7c2000 50%,#b84a00 100%);
  ...
  .card {
    ...
    box-shadow:0 30px 80px #00000050;
  ...
  .logo-icon { width:70px; height:70px; border-radius:20px; background:linear-gradient(135deg,#b84a00,#7c2000); display:flex; align-items:center; justify-content:center; font-size:34px; box-shadow:0 8px 24px #b84a0040; }
  .logo-title { font-size:22px; font-weight:700; color:#2d1200; font-family:'Playfair Display',serif; }
  .logo-sub { font-size:13px; color:#a07060; margin-top:-6px; }

  /* Form */
  .form-group { margin-bottom:18px; }
  label { display:block; font-size:12px; font-weight:600; color:#7c3000; text-transform:uppercase; letter-spacing:0.8px; margin-bottom:7px; }
  .input-wrap { position:relative; }
  .input-wrap span { position:absolute; left:14px; top:50%; transform:translateY(-50%); font-size:16px; }
  input[type=text], input[type=password] {
    width:100%; padding:13px 14px 13px 42px;
    border:1.5px solid #e0d0c0; border-radius:12px;
    font-size:14.5px; color:#2d1200; font-family:'Inter',sans-serif;
    outline:none; transition:border-color .2s, box-shadow .2s;
    background:#faf7f4;
  }
  input:focus { border-color:#b84a00; box-shadow:0 0 0 3px #b84a0015; background:#fff; }

  /* Toggle password */
  .eye-btn { position:absolute; right:14px; top:50%; transform:translateY(-50%); background:none; border:none; cursor:pointer; font-size:16px; color:#a07060; }

  /* Error */
  .error-msg { background:#fff0ee; border:1.5px solid #f0c0b0; border-radius:10px; padding:10px 14px; font-size:13px; color:#b84a00; margin-bottom:18px; display:flex; align-items:center; gap:8px; }

  /* Login button */
  .login-btn {
    width:100%; padding:14px;
    background:linear-gradient(135deg,#b84a00,#7c2000);
    color:#fff; border:none; border-radius:12px;
    font-size:15px; font-weight:700; cursor:pointer;
    font-family:'Inter',sans-serif;
    transition:opacity .2s, transform .1s;
    box-shadow:0 4px 16px #b84a0040;
    margin-top:6px;
  }
  ...
  /* Footer */
  .footer { text-align:center; margin-top:24px; font-size:12px; color:#c0a898; }
  .footer strong { color:#a07060; }
</style>
</head>
<body>
<div class="card">
  <div class="logo-wrap">
    <div class="logo-icon">&#127863;</div>
    <div class="logo-title">madhushalasoftwareGpt</div>
    <div class="logo-sub">Software Assistant — Login</div>
  </div>
  ...
  <form method="POST" action="/login">
    ...
    <button type="submit" class="login-btn">&#128275; Login to Assistant</button>
  </form>

  <div class="footer">
    &copy; 2026 <strong>Madhushala Software</strong> &mdash; Powered by ABM Technomatrix
  </div>
</div>
...
@app.route("/version")
def version():
    return jsonify({"version": get_local_version(), "updater": UPDATER_AVAILABLE})
...
def check_update_route():
    ...
    return jsonify({"update_available": found, "local": local, "remote": remote})
